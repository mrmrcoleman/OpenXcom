...
void create()
{
	...
	_info.push_back(OptionInfo("battleDragScrollButton", &battleDragScrollButton, SDL_BUTTON_RIGHT));
#else
...
#ifdef __EMSCRIPTEN__
	_info.push_back(OptionInfo("geoDragScrollButton", &geoDragScrollButton, SDL_BUTTON_RIGHT));
#else
